...
class Book {
  ...
  factory Book.fromJsonApi(Map<String, dynamic> json) {
    ...
    // CORRECCIÓN: Manejo seguro de autores para evitar crash si la lista está vacía
    ...
    // CORRECCIÓN: Forzar HTTPS en las imágenes para que carguen en móviles
...
class BookService {
  // Usamos authority y path separados para usar Uri.https correctamente
  ...
  Future<List<Book>> searchBooks(String query) async {
    ...
    try {
      // CORRECCIÓN: Uri.https maneja automáticamente los espacios y caracteres especiales
...
class BookProvider extends ChangeNotifier {
  ...
  // CORRECCIÓN: Se agregaron los espacios faltantes en las declaraciones
